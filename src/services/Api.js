...
export const getOrderCustomer = (id,config)=>Http.get(`customer/${id}/orders`,config);
export const getOrdersCustomer = (id,config)=>Http.get(`customer/order/${id}`,config);
export const canceledOrdersCustomer = (id)=>Http.get(`customer/order/${id}/canceled`);
